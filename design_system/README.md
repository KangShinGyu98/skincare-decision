...
The service does NOT simply recommend products. It first gates users through a structured decision flow to determine *if* they should be buying anything at all, then narrows down candidates using personalized filters.
...
- **Honest and probabilistic**: Results are framed as *candidates* and *possibilities*, never definitive diagnoses. E.g., "원인 후보로 볼 수 있는 성분군" (not "this caused your reaction").
