...
- **Product Matrix** — Tier-list product comparison with filters
...
- Mobile-first layout (max 480px on mobile, full-width admin/desktop)
- All components are in `Components.jsx`, imported by screen files
