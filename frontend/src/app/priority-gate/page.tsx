...
export default function PriorityGatePage() {
  ...
  return (
    <TooltipProvider>
      ...
      >
        <div className="flex min-h-0 w-full max-w-[1200px] flex-[1] flex-col items-center justify-center gap-2 text-center">
          <h2 className="mb-0!">루틴을 점검하고 우선순위를 결정해드립니다.</h2>
