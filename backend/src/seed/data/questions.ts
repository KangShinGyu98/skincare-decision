...
export const QUESTION_SEEDS = [
  ...
  { key: 'routine.cleansing_stable', answerType: 'SINGLE_CHOICE', answerValues: [0, 1] },
  { key: 'routine.foam_enough', answerType: 'SINGLE_CHOICE', answerValues: [0, 1] },
  { key: 'routine.eye_irritation_history', answerType: 'SINGLE_CHOICE', answerValues: [0, 1] },
  { key: 'routine.recent_dry_tight', answerType: 'SINGLE_CHOICE', answerValues: [0, 1] },
  { key: 'routine.makeup_frequent', answerType: 'SINGLE_CHOICE', answerValues: [0, 1] },
  { key: 'routine.bedtime_routine', answerType: 'SINGLE_CHOICE', answerValues: [0, 1] },
  { key: 'routine.cleansing_before_sleep', answerType: 'SINGLE_CHOICE', answerValues: [0, 1] },
  {
    key: 'flow.concern',
  ...
  { key: 'preference.menthol_sensitive', answerType: 'SINGLE_CHOICE', answerValues: [0, 1] },
  { key: 'context.exfoliation_sensitive', answerType: 'SINGLE_CHOICE', answerValues: [0, 1] },
  { key: 'context.oil_control_need', answerType: 'SINGLE_CHOICE', answerValues: [0, 1] },
  { key: 'context.daily_use', answerType: 'SINGLE_CHOICE', answerValues: [0, 1] },
  { key: 'context.acne_prone', answerType: 'SINGLE_CHOICE', answerValues: [0, 1] },
  { key: 'context.eye_sting', answerType: 'SINGLE_CHOICE', answerValues: [0, 1] },
  { key: 'context.white_cast_sensitive', answerType: 'SINGLE_CHOICE', answerValues: [0, 1] },
  ...
  { key: 'context.prefer_lightweight', answerType: 'SINGLE_CHOICE', answerValues: [0, 1] },
  { key: 'context.double_cleanse_needed', answerType: 'SINGLE_CHOICE', answerValues: [0, 1] },
