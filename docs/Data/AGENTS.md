...
| 파일명                                                       | 목적                                                                      | 구성요소                                                                                  |
| ------------------------------------------------------------ | ------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- |
| [db_modeling.md](db_modeling.md)                             | 현실 문제를 DB 테이블로 매핑하는 과정 정리                                | 테이블 목록(25개), 컬럼 정의, 관계도, 신원 3계층, fact_key 사전, attribute 사전           |
| [db_schema_validation.md](db_schema_validation.md)           | schema.prisma + migration.sql과 db_modeling.md의 교차 검증 레퍼런스  | Prisma→PG 자료형 매핑, enum 19종, 테이블별 컬럼 표, 인덱스 목록, FK 정책, docs 불일치     |
