...
> 영문 스킨케어 아티클 / 제목 / 메모 크롤링 결과. `docs/ContentSpec/skincare_product_selection_rule.md` 작성에 사용한 원자료다.
...
3. 룰 추가 시 `docs/ContentSpec/skincare_product_selection_rule.md` → `docs/ContentSpec/matching_rules_revised.md` 순으로 반영하고 `memory/project_decisions.md`에 근거를 기록.
4. 영문 텍스트는 한국 사용자 의도와 차이가 있을 수 있다 — 그대로 번역하지 말고 `docs/ContentSpec/skincare_product_selection_rule.md` 한국어 표현을 따른다.
