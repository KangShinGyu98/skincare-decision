...
| 체크 항목      | 질문 예시                                          |
| -------------- | -------------------------------------------------- |
| 최근 자극 여부 | 최근 7일 안에 따가움, 붉어짐, 가려움이 반복됐나요? |
| 루틴 변경 과다 | 최근 2주 안에 새 제품을 2개 이상 추가했나요?       |
| 야외 활동      | 낮에 밖에 있는 시간이 많은 편인가요?               |
| 선크림 사용    | 선크림을 거의 매일 바르나요?                       |
| 클렌징 안정성  | 선크림/메이크업 후 클렌징이 잘 되고 있나요?        |
| 건조 / 당김    | 세안 후 당김, 건조, 따가움이 자주 있나요?          |
| 보습 루틴      | 보습제를 매일 꾸준히 사용하나요?                   |
| 메이크업 여부  | 베이스 메이크업을 자주 하나요?                     |
...
| 최근 새 제품을 많이 추가함                            | 지금은 새 제품보다 현재 루틴을 7~14일 고정하는 게 먼저예요.    |
| 야외 활동 많음 + 선크림 불안정                        | 세럼보다 선크림 루틴이 먼저예요.                               |
| 선크림을 사용감 때문에 생략함                         | 매일 쓸 수 있는 선크림을 먼저 찾아야 해요.                     |
| 선크림/메이크업 사용 + 클렌징 불안정                  | 새 제품보다 클렌징 루틴 점검이 먼저예요.                       |
| 세안 후 당김 / 건조 / 따가움 반복                     | 기능성 제품보다 보습 루틴 고정이 먼저예요.                     |
| 보습제를 꾸준히 쓰지 않음                             | 수분 세럼보다 매일 쓸 수 있는 로션/크림이 먼저예요.            |
...
| life.outdoor_activity = high          | spf >= 50                     | HARD_FILTER | 야외 사용 적합 |
